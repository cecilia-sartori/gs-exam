...
Thanks to global autocorrelation, I know for a fact that our data do have a general pattern and do not cluster by accident. But, I don't know yet if there is a local pattern. To find that out, run the local indicators of spatial association (LISA) analysis.
